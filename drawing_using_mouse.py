...
# Brush types
brushes = {"round": False, "square": False, "ellipse": False}
...
def brush(x, y):
    ...
    elif brushes["ellipse"]:
        return pygame.draw.ellipse(screen, color, (x, y, brush_size, brush_size))
...
while True:
    ...
    red_button = pygame.draw.rect(
        screen, RED, (0, WINDOW_SIZE[1] - 32, 32, 32))
    blue_button = pygame.draw.rect(
        screen, BLUE, (32, WINDOW_SIZE[1] - 32, 32, 32))
    green_button = pygame.draw.rect(
        screen, GREEN, (64, WINDOW_SIZE[1] - 32, 32, 32))
    cyan_button = pygame.draw.rect(
        screen, CYAN, (96, WINDOW_SIZE[1] - 32, 32, 32))
    yellow_button = pygame.draw.rect(
        screen, YELLOW, (128, WINDOW_SIZE[1] - 32, 32, 32))
    magenta_button = pygame.draw.rect(
        screen, MAGENTA, (160, WINDOW_SIZE[1] - 32, 32, 32))
    white_button = pygame.draw.rect(
        screen, WHITE, (192, WINDOW_SIZE[1] - 32, 32, 32))
    black_button = pygame.draw.rect(
        screen, BLACK, (224, WINDOW_SIZE[1] - 32, 32, 32))

    # Brush buttons
    round_brush = pygame.draw.circle(
        screen, BLACK, (WINDOW_SIZE[0] - 16, WINDOW_SIZE[1] - 16), 16, 0)
    square_brush = pygame.draw.rect(
        screen, BLACK, (WINDOW_SIZE[0] - 64, WINDOW_SIZE[1] - 32, 32, 32))
    ellipse_brush = pygame.draw.ellipse(
        screen, BLACK, (WINDOW_SIZE[0] - 96, WINDOW_SIZE[1] - 32, 32, 32))
    ...
    for event in pygame.event.get():
        ...
        if event.type == MOUSEBUTTONDOWN:
            ...
            elif ellipse_brush.collidepoint(mouse_x, mouse_y):
                brushes["round"] = False
                brushes["ellipse"] = True
                brushes["square"] = False
