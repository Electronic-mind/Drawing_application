...
while True:
    ...
    pygame.draw.line(screen, BLACK, (0, WINDOW_HEIGHT - 33), (WINDOW_WIDTH, WINDOW_HEIGHT - 33))
    # Color buttons
    red_button = pygame.draw.rect(
        screen, RED, (0, WINDOW_HEIGHT - 32, 32, 32))
    blue_button = pygame.draw.rect(
        screen, BLUE, (32, WINDOW_HEIGHT - 32, 32, 32))
    green_button = pygame.draw.rect(
        screen, GREEN, (64, WINDOW_HEIGHT - 32, 32, 32))
    cyan_button = pygame.draw.rect(
        screen, CYAN, (96, WINDOW_HEIGHT - 32, 32, 32))
    yellow_button = pygame.draw.rect(
        screen, YELLOW, (128, WINDOW_HEIGHT - 32, 32, 32))
    magenta_button = pygame.draw.rect(
        screen, MAGENTA, (160, WINDOW_HEIGHT - 32, 32, 32))
    white_button = pygame.draw.rect(
        screen, WHITE, (192, WINDOW_HEIGHT - 32, 32, 32))
    black_button = pygame.draw.rect(
        screen, BLACK, (224, WINDOW_HEIGHT - 32, 32, 32))

    # Brush buttons
    round_brush = pygame.draw.circle(
        screen, BLACK, (WINDOW_WIDTH - 16, WINDOW_HEIGHT - 16), 16, 0)
    square_brush = pygame.draw.rect(
        screen, BLACK, (WINDOW_WIDTH - 64, WINDOW_HEIGHT - 32, 32, 32))

    # Eraser button
    eraser_text = sys_font.render("Erase all", True, BLACK, WHITE)
    eraser_button = eraser_text.get_rect()
    eraser_button.topright = (WINDOW_WIDTH, 0)
